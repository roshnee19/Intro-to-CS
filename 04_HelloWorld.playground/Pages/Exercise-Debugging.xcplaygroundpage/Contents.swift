...
//Below is the incessant question
print("\(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)?")
//Below is the botheration
print("\(name), \(name), \(name)! \n\(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)? \(connectorWord) \(questionWord)?")
