...
let totalTimeOfActivites = brushTeeth + uploadPhotos + chooseClothes + shower + eatBreakfast + goJogging + finishHomework + fixLunch + playWithDog
...
let totalTimeOfActivitiesIHaveToDo = chooseClothes + eatBreakfast + finishHomework + brushTeeth
let totalTimeOfActivitiesIDoNotDo = uploadPhotos + goJogging + fixLunch
let totalTimeOfActivitesIWishICouldDo = shower + playWithDog
...
*/
// the timing distribution above is the default morning routine 
